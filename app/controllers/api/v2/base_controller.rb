  ...
  module V2
    class BaseController < Api::BaseController
      ...
      resource_description do
        api_version "v2"
        app_info N_("Foreman v2 is currently in development and is not the default version. You may use v2 by either passing 'version=2' in the Accept Header or entering api/v2/ in the URL.")
      end
