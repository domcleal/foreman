module Api
  module V2
    class OsDefaultTemplatesController < V2::BaseController
      ...
      api :GET, '/operatingsystems/:operatingsystem_id/os_default_templates', N_('List os default templates for operating system')
      ...
      api :GET, "/operatingsystems/:operatingsystem_id/os_default_templates/:id", N_("Show a os default template kind for operating system")
      param :operatingsystem_id, String, :desc => N_("id of operating system")
      ...
      api :POST, "/operatingsystems/:operatingsystem_id/os_default_templates/", N_("Create a os default template for operating system")
      param :operatingsystem_id, String, :desc => N_("id of operating system")
      ...
      api :PUT, "/operatingsystems/:operatingsystem_id/os_default_templates/:id", N_("Update a os default template for operating system")
      param :operatingsystem_id, String, :desc => N_("id of operating system")
      ...
      api :DELETE, "/operatingsystems/:operatingsystem_id/os_default_templates/:id", N_("Delete a os default template for operating system")
      param :operatingsystem_id, String, :desc => N_("id of operating system")
      param :id, String, :required => true
