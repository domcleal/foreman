module Api
  module V2
    class PuppetclassesController < V2::BaseController
      ...
      api :GET, "/puppetclasses/", N_("List all puppetclasses.")
      api :GET, "/hosts/:host_id/puppetclasses", N_("List all puppetclasses for host")
      api :GET, "/hostgroups/:hostgroup_id/puppetclasses", N_("List all puppetclasses for hostgroup")
      api :GET, "/environments/:environment_id/puppetclasses", N_("List all puppetclasses for environment")
      param :host_id, String, :desc => N_("id of nested host")
      param :hostgroup_id, String, :desc => N_("id of nested hostgroup")
      param :environment_id, String, :desc => N_("id of nested environment")
      ...
      api :GET, "/puppetclasses/:id", N_("Show a puppetclass")
      api :GET, "/hosts/:host_id/puppetclasses/:id", N_("Show a puppetclass for host")
      api :GET, "/hostgroups/:hostgroup_id/puppetclasses/:id", N_("Show a puppetclass for hostgroup")
      api :GET, "/environments/:environment_id/puppetclasses/:id", N_("Show a puppetclass for environment")
      param :host_id, String, :desc => N_("id of nested host")
      param :hostgroup_id, String, :desc => N_("id of nested hostgroup")
      param :environment_id, String, :desc => N_("id of nested environment")
      ...
      api :POST, "/puppetclasses/", N_("Create a puppetclass.")
      ...
      api :PUT, "/puppetclasses/:id/", N_("Update a puppetclass.")
      ...
      api :DELETE, "/puppetclasses/:id/", N_("Delete a puppetclass.")
      param :id, String, :required => true
