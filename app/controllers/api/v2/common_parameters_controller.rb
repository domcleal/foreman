...
module Api
  module V2
    class CommonParametersController < V2::BaseController
      ...
      api :GET, "/common_parameters/", N_("List all common parameters.")
      ...
      api :GET, "/common_parameters/:id/", N_("Show a common parameter.")
      ...
      api :POST, "/common_parameters/", N_("Create a common_parameter")
      ...
      api :PUT, "/common_parameters/:id/", N_("Update a common_parameter")
      param :id, :identifier, :required => true
      ...
      api :DELETE, "/common_parameters/:id/", N_("Delete a common_parameter")
      param :id, :identifier, :required => true
