module Api
  module V2
    class HostgroupClassesController < V2::BaseController
      ...
      api :GET, "/hostgroups/:hostgroup_id/puppetclass_ids/", N_("List all puppetclass id's for hostgroup")
      ...
      api :POST, "/hostgroups/:hostgroup_id/puppetclass_ids", N_("Add a puppetclass to hostgroup")
      param :hostgroup_id, String, :required => true, :desc => N_("id of hostgroup")
      ...
      api :DELETE, "/hostgroups/:hostgroup_id/puppetclass_ids/:id/", N_("Remove a puppetclass from hostgroup")
      param :hostgroup_id, String, :required => true, :desc => N_("id of hostgroup")
